...
<form action="adminlogin.php" method="POST">
    ...
    <input type="text" id="fname" name="uname" placeholder="Your user name.." required><br>

    <label for="Password">Password</label><br>
    <input type="password" id="emai" name="pass" placeholder="Your password.." required><br>
