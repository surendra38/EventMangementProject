...
<body>
<script>
document.forms["myForm"]["rnumber"]..style.display = "none";
</script>
<div class="container">
...
<tr>
  ...
  <select name="ename" id="event">
    ...
    <option value="Invertia">Invertia</option>
    <option value="Fresher">Fresher</option>
    <option value="farewal">Farewal</option>
  </select>
</td>
</tr>
<tr>
...
<tr>
<td>Name</td>
<td><input type="text" name="sname" placeholder="Enter your name" size="30" required></td>
</tr>
<tr>
<td>Department</td>
<td><input type="text" name="dname" placeholder="Enter your department name" size="30" required></td>
</tr>
<tr>
<td>course</td>
...
<footer>
<h2 style="text-align:center;color:white;padding-top:20px;">copyright @ 2017-18</h2>
